...
class ReplicaGroup:
    ...
    @param comp_dic: value:component key:priority
    @param primary_conns: Array of Connection
    @param current_primary: Current primary component
    @param primary_state: Internal states of the primary component
    """
